...
\item[]
    \headerrow {\textbf{Stock Price Prediction}}{Prof. Nguyen Hung Minh Tan}
    \headerrow {\emph{Machine Learning Project}}{\emph{Oct 2023 - Nov 2023}}

    \begin{itemize*}
        \item
            Performed time series analysis with \textbf{seasonal decomposition} and \textbf{stationarity} test to identify patterns.
        \item
            Used techniques like \textbf{Moving Average} and \textbf{Exponential Smoothing} to approximate prices and remove noise.
        \item
            Implemented cross-validation and parameter grid search for model selection to reduce bias and overfitting.
        \item
            Applied diverse forecasting methods from \textbf{ARIMA} (and VARMAX) to Recurrent Neural Networks
            like \textbf{LSTM}.
    \end{itemize*}


\item[]
    \headerrow {\textbf{MiniMovieDB}}{Prof. Xiaoyan Yang}
