...
\item[]
    ...
    \begin{itemize*}
        ...
        \item
            Improved performance on sparse graphs with \textbf{optimizations} like the Alias Method and "densifying".
        \item
            Visualized performance against existing solvers like Dan Spielman's and Bechetti's: \\
            Overall, it's \textbf{better than} Bechetti's. With a lot of parameter fine-tuning, it's \textbf{comparable with} Dan's.
    \end{itemize*}
...
\item[]
    ...
    \begin{itemize*}
        ...
        \item
            ...
            to choose the next move to evaluate.
        \item
