...
\item[]
    ...
    \begin{itemize*}
        ...
        \item
            Utilized diverse forecasting methods, including \textbf{ARIMA} and \textbf{LSTM} (Recurrent Neural Network).
        \item
            Backtested models against historical data to assess predictive performance and validate effectiveness.
    \end{itemize*}
